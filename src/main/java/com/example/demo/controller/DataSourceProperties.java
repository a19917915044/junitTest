...
@PropertySource(value = {"file:C:\\tools\\data.properties"},ignoreResourceNotFound = true)
public class DataSourceProperties {
     ...
     * Druid默认参数
     */
    @Value("${remote.initialSize:${spring.datasource.druid.initialSize:#{60 * 1000L}}}")
    private int initialSize = 2;
    private int maxActive = 10;
    private int minIdle = -1;
    @Value("${remote.maxWait:${spring.datasource.druid.maxWait:#{60 * 1000L}}}")
